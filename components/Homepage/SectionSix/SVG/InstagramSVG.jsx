...
const InstagramSVG = () => {
  return (
	<MagneticButton>
		<div className='group-hover:scale-110 group-hover:bg-gradient-to-l group-hover:from-[#d70686] group-hover:to-[#FFAE00] bg-transparent p-[4px] rounded-lg'>
			<svg fill="#ffff" height="25px" width="25px" version="1.1" id="Layer_1" viewBox="-271 273 256 256">
